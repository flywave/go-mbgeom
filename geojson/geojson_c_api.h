...
GEOJSONCAPICALL void mapbox_point_get_xy(mapbox_point_t *pt, double *x,
                                       double *y);
GEOJSONCAPICALL void mapbox_point_set_xy(mapbox_point_t *pt, double x, double y);
...
GEOJSONCAPICALL int mapbox_line_string_get_points_count(mapbox_line_string_t *pt);
...
GEOJSONCAPICALL int mapbox_multi_point_get_points_count(mapbox_multi_point_t *pt);
...
GEOJSONCAPICALL int mapbox_linear_ring_get_points_count(mapbox_linear_ring_t *pt);
...
GEOJSONCAPICALL mapbox_polygon_t *mapbox_polygon_new(mapbox_linear_ring_t **rings,
                                                   int ringcount);
...
GEOJSONCAPICALL char **mapbox_property_map_keys(mapbox_property_map_t *val, int *count);
...
GEOJSONCAPICALL mapbox_identifier_t *mapbox_identifier_from_string(const char *v);
