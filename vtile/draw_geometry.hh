...
struct draw {
  ...
  draw(int nop, long long nx, long long ny)
      : x(nx), op(nop), y(ny), necessary(0) {}

  draw() : x(0), op(0), y(0), necessary(0) {}
  ...
  bool operator==(draw const &s) const { return y == s.y && x == s.x; }
...
drawvec simple_clip_poly(drawvec &geom, long long x1, long long y1,
                         long long x2, long long y2);
drawvec clip_lines(drawvec &geom, long long x1, long long y1, long long x2,
                   long long y2);
drawvec clip_point(drawvec &geom, long long x1, long long y1, long long x2,
                   long long y2);
