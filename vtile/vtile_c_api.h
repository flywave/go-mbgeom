...
VTILECAPICALL bool mvt_vector_tile_empty(mvt_vector_tile_t *ctx);
...
VTILECAPICALL bool mvt_vector_tile_is_vector_tile(const char *data, size_t si);
...
VTILECAPICALL bool mvt_layer_valid(mvt_layer_t *ctx);
...
VTILECAPICALL bool mvt_layer_empty(mvt_layer_t *ctx);
...
VTILECAPICALL bool mvt_feature_valid(mvt_feature_t *ctx);
VTILECAPICALL uint64_t mvt_feature_get_id(mvt_feature_t *ctx);
VTILECAPICALL bool mvt_feature_has_id(mvt_feature_t *ctx);
...
VTILECAPICALL bool mvt_feature_empty(mvt_feature_t *ctx);
...
VTILECAPICALL bool mvt_feature_next_property_indexes(mvt_feature_t *ctx,
                                                      uint32_t *key,
                                                      uint32_t *value);
...
VTILECAPICALL bool mvt_property_valid(mvt_property_t *prop);
...
VTILECAPICALL bool mvt_property_value_valid(mvt_property_value_t *pv);
